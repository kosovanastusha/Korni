...
bin/equation_test.exe: build/test/main.o test/Korni_test.o
	@gcc $(CFLAGS) build/test/main.o test/Korni_test.o build/Korni.o -o Korni_test.exe -lm
...
build/test/function_test.o: src/Korni.h test/Korni_test.c
	@gcc $(CFlAGS) -I thirdparty -c test/Korni_test.c -o test/Korni_test.o  -lm 
clean:
